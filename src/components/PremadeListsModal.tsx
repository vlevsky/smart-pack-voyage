...
const premadeLists: PremadeList[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Champagne flutes', category: 'miscellaneous', quantity: 2, thoroughnessLevel: 'thorough' },
  ...
  },
  {
    ...
    description: 'Budget-friendly island hopping and cultural exploration',
    destinationType: 'backpacking',
    season: 'winter',
    duration: '14-30 days',
    icon: '🎒',
    items: [
      { name: 'Quick-dry shorts', category: 'clothes', quantity: 4 },
      { name: 'Tank tops', category: 'clothes', quantity: 6 },
      { name: 'Lightweight pants', category: 'clothes', quantity: 3 },
      { name: 'Flip flops', category: 'clothes', quantity: 2 },
      { name: 'Hiking sandals', category: 'clothes', quantity: 1 },
      { name: 'Temple-appropriate clothing', category: 'clothes', quantity: 3 },
      { name: 'Rain poncho', category: 'clothes', quantity: 1 },
      { name: 'Mosquito repellent', category: 'toiletries', quantity: 3 },
      { name: 'Sunscreen', category: 'toiletries', quantity: 3 },
      { name: 'Diarrhea medication', category: 'toiletries', quantity: 1 },
      ...
      { name: 'Dry bags', category: 'miscellaneous', quantity: 3 },
      { name: 'Hostel padlock', category: 'miscellaneous', quantity: 2 },
      ...
      { name: 'Backup passport photos', category: 'documents', quantity: 4 },
      { name: 'Emergency cash', category: 'documents', quantity: 1 },
      { name: 'Snorkeling gear', category: 'miscellaneous', quantity: 1 },
      { name: 'Lightweight backpack', category: 'miscellaneous', quantity: 1 },
      { name: 'Money belt', category: 'miscellaneous', quantity: 1 },
      { name: 'Thai phrasebook', category: 'documents', quantity: 1 },
      { name: 'Headlamp', category: 'electronics', quantity: 1 },
      { name: 'Earplugs', category: 'miscellaneous', quantity: 10 },
    ],
  },
  {
    id: 'bali-wellness',
    name: 'Bali Wellness Retreat',
    description: 'Spiritual journey with yoga, meditation, and healing',
    destinationType: 'wellness',
    season: 'spring',
    duration: '7-14 days',
    icon: '🧘',
    items: [
      { name: 'Yoga mats', category: 'miscellaneous', quantity: 1 },
      { name: 'Yoga blocks', category: 'miscellaneous', quantity: 2 },
      { name: 'Meditation cushion', category: 'miscellaneous', quantity: 1 },
      { name: 'Yoga pants', category: 'clothes', quantity: 5 },
      { name: 'Tank tops', category: 'clothes', quantity: 6 },
      { name: 'Comfortable t-shirts', category: 'clothes', quantity: 4 },
      { name: 'Light cardigan', category: 'clothes', quantity: 2 },
      { name: 'Breathable underwear', category: 'clothes', quantity: 8 },
      { name: 'Flip flops', category: 'clothes', quantity: 2 },
      { name: 'Comfortable sandals', category: 'clothes', quantity: 1 },
      { name: 'Temple wear', category: 'clothes', quantity: 2 },
      { name: 'Swimwear', category: 'clothes', quantity: 3 },
      { name: 'Natural sunscreen', category: 'toiletries', quantity: 2 },
      { name: 'Organic insect repellent', category: 'toiletries', quantity: 1 },
      ...
      { name: 'Crystals', category: 'miscellaneous', quantity: 3, thoroughnessLevel: 'thorough' },
      { name: 'Mala beads', category: 'miscellaneous', quantity: 1, thoroughnessLevel: 'balanced' },
      { name: 'Kindle with spiritual books', category: 'electronics', quantity: 1 },
      { name: 'Camera for nature shots', category: 'electronics', quantity: 1 },
    ],
  },
